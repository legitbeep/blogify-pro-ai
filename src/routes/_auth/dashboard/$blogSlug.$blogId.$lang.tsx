...
export const Route = createFileRoute(
  "/_auth/dashboard/$blogSlug/$blogId/$lang"
)({
...
function BlogEditComponent() {
  const { blogId, lang } = useParams({
    from: "/_auth/dashboard/$blogSlug/$blogId/$lang",
  });
  ...
  const onLangChange = (language: LanguageType) => {
    // navigate to the new lang
    navigate({
      to: `/dashboard/${blogId}/${language?.value ?? "en"}`,
    });
  };
    ...
    <>
      ...
      <div className="p-4 container min-h-[90dvw] mt-32 mx-auto">
        ...
        <div className="mt-4">
          ...
          <LanguageSelector defaultValue={lang} onLangChange={onLangChange} />
